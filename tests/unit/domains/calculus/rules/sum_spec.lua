...
describe("Calculus Sum Rule: tungsten.domains.calculus.rules.sum", function()
  ...
  before_each(function()
    ...
    test_grammar_table_definition = {
      ...
      Expression = (
        P("i^2") / function() return placeholder_node("placeholder_expr", "i^2", "power_i2") end +
        P("k^3") / function() return placeholder_node("placeholder_expr", "k^3", "power_k3") end +
        P("1/n") / function() return placeholder_node("placeholder_expr", "1/n", "fraction_1n") end +
        P("a_k") / function() return placeholder_node("placeholder_expr", "a_k", "subscript_ak") end +
        P("\\alpha") / function() return { type = "symbol", name = "alpha" } end +
