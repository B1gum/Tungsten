...
describe("Calculus Integral Rule: tungsten.domains.calculus.rules.integral", function()
	before_each(function()
		...
		test_grammar_table_definition = {
			...
			Expression = (
				P("t^2") / function()
					return placeholder_node("placeholder_expr", "t^2", "power")
				end
				+ P("x^2") / function()
					return placeholder_node("placeholder_expr", "x^2", "power")
				end
				+ P("f(t)") / function()
					return placeholder_node("placeholder_expr", "f(t)", "function_call")
				end
				+ P("sin(y)") / function()
					return placeholder_node("placeholder_expr", "sin(y)", "function_call_sin")
				end
				+ P("E") / function()
					return placeholder_node("placeholder_expr", "E", "constant_E")
				end
				+ P("-\\infty") / function()
	...
	local indefinite_integrals_data = {
		...
		{
			"f(t) d t (note space in 'd t')",
			"\\int f(t) %s d t",
			placeholder_node("placeholder_expr", "f(t)", "function_call"),
			"t",
		},
		{
			"sin(y) dAlpha (multichar var)",
			"\\int sin(y) %s dAlpha",
			placeholder_node("placeholder_expr", "sin(y)", "function_call_sin"),
			"Alpha",
		},
	}
	...
	local definite_integrals_data = {
		...
		{
			"_{a}^{b} t^2 \\mathrm{d}t",
			"\\int_{a}^{b} t^2 %s \\mathrm{d}t",
			{ type = "variable", name = "a" },
			{ type = "variable", name = "b" },
			placeholder_node("placeholder_expr", "t^2", "power"),
			"t",
		},
		{
			"_{-\\infty}^{\\infty} f(t) d t",
			"\\int_{-\\infty}^{\\infty} f(t) %s d t",
