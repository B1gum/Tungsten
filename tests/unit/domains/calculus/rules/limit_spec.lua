	...
	before_each(function()
		...
		test_grammar_table_definition = {
			...
			Expression = (
				P("{x^2 + 2x - 3}")
					/ function()
						return placeholder_node("placeholder_expr", "{x^2 + 2x - 3}", "complex_braced_in_mock")
					end
				+ P("x^2 + 2x - 3") / function()
					return placeholder_node("placeholder_expr", "x^2 + 2x - 3", "complex_unbraced_in_mock")
				end
				+ (P("1") * P("/") * P("n")) / function()
					return placeholder_node("placeholder_expr", "1/n", "fraction")
				end
				+ (P("t") * P("^") * P("2")) / function()
					return placeholder_node("placeholder_expr", "t^2", "power")
				end
				+ (P("f") * P("(") * P("x") * P(")")) / function()
					return placeholder_node("placeholder_expr", "f(x)", "function_call")
				end
