...
describe("tungsten.util.insert_result", function()
	...
	after_each(function()
		...
		if _G.vim.fn.split and type(_G.vim.fn.split) == "table" and _G.vim.fn.split.clear then
			_G.vim.fn.split:clear()
		end
		if
			_G.vim.api.nvim_buf_set_text
			and type(_G.vim.api.nvim_buf_set_text) == "table"
			and _G.vim.api.nvim_buf_set_text.clear
		then
			_G.vim.api.nvim_buf_set_text:clear()
		end
		if _G.vim.fn.mode and type(_G.vim.fn.mode) == "table" and _G.vim.fn.mode.clear then
			_G.vim.fn.mode:clear()
		end
		if
			_G.vim.api.nvim_buf_get_lines
			and type(_G.vim.api.nvim_buf_get_lines) == "table"
			and _G.vim.api.nvim_buf_get_lines.clear
		then
			_G.vim.api.nvim_buf_get_lines:clear()
		end
