...
describe("Optional integrations", function()
  ...
  describe("Status window", function()
    it("creates a window displaying job details", function()
      ...
      local create_buf_spy = spy.new(function() return 42 end)
      local set_lines_spy = spy.new(function() end)
      local open_win_spy = spy.new(function() return 10 end)
      ...
      mock_utils.mock_module('tungsten.core.engine', { get_active_jobs_summary = function() return 'line1\nline2' end })
