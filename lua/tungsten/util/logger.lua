...
function M.debug(title, msg)
	send(M.levels.DEBUG, title, msg)
end
function M.info(title, msg)
	send(M.levels.INFO, title, msg)
end
function M.warn(title, msg)
	send(M.levels.WARN, title, msg)
end
function M.error(title, msg)
	send(M.levels.ERROR, title, msg)
end
