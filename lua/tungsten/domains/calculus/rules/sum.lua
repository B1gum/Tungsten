...
local subscript_content_pattern =
  variable_capture * space *
  equals_sign * space *
  start_expr_capture

local full_subscript_pattern =
  subscript_marker * space *
  tk.lbrace * space *
  subscript_content_pattern *
  space * tk.rbrace

local full_superscript_pattern =
  superscript_marker * space *
  tk.lbrace * space *
  end_expr_capture *
  space * tk.rbrace

local main_body_expression_segment =
  space * (
    (tk.lbrace * space * body_expr_capture * space * tk.rbrace) +
    body_expr_capture
  )
